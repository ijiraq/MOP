...
def run(expnum, ccd, version, dry_run=False, prefix="", force=False, ignore_dependency=False, ext_no=0):
...
def main():
    ...
    parser.add_argument('--ext-no', type=int, default=0, help='Which extension holds the image')
